...
function createConfigSheet(ss) {
  ...
  if (!sheet) {
    ...
    const configData = [
      ['shopName', 'ร้านของฉัน'],              // แก้ไข: ไม่ hardcode ชื่อร้าน
      ['isOpen', 'true'],
      ['liffId', liffIdFromProp],               // แก้ไข: ดึงจาก Script Properties
      ['taxRate', '0'],
      ['serviceCharge', '0'],
      ['currency', 'THB'],
      ['phoneNumber', ''],                       // แก้ไข: ว่างไว้ให้ admin กรอกเอง
      ['openTime', '08:00'],
      ['closeTime', '20:00'],
      ['address', ''],                           // แก้ไข: ว่างไว้ให้ admin กรอกเอง
      ['lineOfficial', '']                       // แก้ไข: ว่างไว้ให้ admin กรอกเอง
    ];
